...
<%@page import="Ranking.*" %>
<%@page import="CompraInvestimento.DadosEmpresa" %>
 ...
 <header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <%
        ...
        dados = DadosEmpresa.getData(empresa);
    ...
    <section class="content">
            ...
            <div class="box-header">
               <div class="col-md-4">
                <div class="widget-user-image">
                    ...
                    <img class="img-circle" src="dist/img/<%= dados.get(0) %>.jpg" alt="User Avatar">
                    </div>
               </div>
                <div class="col-md-4">
                    <b> <h1><center> Capital da Empresa </center><h1></b>
                       </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                   <div class="col-md-5">
                                          <b> <h1>  <%=request.getParameter("nome")%><h1></b>    
                                                      </div>
                                          <b> <h1><u>   R$ <%=dados.get(1)%> </u> <h1></b>     
      ...
      <div class="form-group has-feedback">
          <div class="row">
          <div class="col-xs-4">
              <h2>Quantidade de Ações Disponiveis: <%= dados.get(4)%></h2>
          </div>
          <div class="col-xs-5">
        ...
        <input type="hidden" name="Empresa"  value= <%= request.getParameter("nome") %>>
        <input type="hidden" name="id_comprado"  value= <%= dados.get(0) %>>
        <input type="hidden" name="usr"  value= <%=request.getParameter("usr")%>>
        <input type="hidden" name="emp"  value= <%=request.getParameter("emp") %>>
        <input type="hidden" name="id_usr"  value= <%=request.getParameter("id") %>>
        <input type="hidden" name="valor"  value=  <%= dados.get(3)%>>

              
          <div class="col-sm-1">
          <%
              if(request.getParameter("msg") != null){
         out.println("<font color='red'>Valor Invalido</font><br>");
          }
              %>
              </div>
          </div>
      ...
      <div class="row">
        <div class="col-xs-1">
            ...
            <div class="col-xs-8">
                <h2>Valor de Cada Ação <%= dados.get(3)%></h2>
        </div>
         <!-- /.col -->
        <div class="col-xs-2">
            
          <button type="submit" class="btn btn-primary btn-block btn-flat">Comprar</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
